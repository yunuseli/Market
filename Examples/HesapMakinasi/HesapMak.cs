namespace HesapMakinasi
{
  public partial class HesapMak : Form
  {
    ...
    {
      // klavyeden basýlan tuþu yakalayýp, buton iþlemini tetikleme
      switch (e.KeyData)
      {
        case Keys.D0:
          btn0.PerformClick();
    ...
    //  // Virgülle baþladý ise 0, yap
    //  if (giris.StartsWith(",") && giris.Length == 1)
    //    giris = $"0{giris}";

    //  // Sýfýrla baþladý ise, arkadan gelen virgül deðilse, baþtaki sýfýrý sil
