...
namespace KimlikDogrulamaServisi
{
    ...
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<KimlikDogrulamaServisi.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(KimlikDogrulamaServisi.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public KimlikDogrulamaServisi.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(KimlikDogrulamaServisi.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public KimlikDogrulamaServisi.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(KimlikDogrulamaServisi.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface KPSPublicSoapChannel : KimlikDogrulamaServisi.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<KimlikDogrulamaServisi.KPSPublicSoap>, KimlikDogrulamaServisi.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<KimlikDogrulamaServisi.TCKimlikNoDogrulaResponse> KimlikDogrulamaServisi.KPSPublicSoap.TCKimlikNoDogrulaAsync(KimlikDogrulamaServisi.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<KimlikDogrulamaServisi.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            KimlikDogrulamaServisi.TCKimlikNoDogrulaRequest inValue = new KimlikDogrulamaServisi.TCKimlikNoDogrulaRequest();
            inValue.Body = new KimlikDogrulamaServisi.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((KimlikDogrulamaServisi.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
