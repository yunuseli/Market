...
namespace Market.Business.Classes.ProductCategoryManagers
{
  public class ProductCategoryManager
  {
    ...
    public void CreateCategoryTable(out ResultObject result)
    {
    ...
    public List<Category> ListCategory(out ResultObject result, bool isDeleted, bool isActive = false)
    {
      result = new ResultObject();
      ...
      try
      {
        ...
        //  category.CreatedOn = Convert.ToDateTime(dr["CreatedOn"]);
        //  category.LastModifiedBy = dr["LastModifiedBy"].ToString();
        //  category.LastModifiedOn = Convert.ToDateTime(dr["LastModifiedOn"]);
        //  category.IsActive = Convert.ToBoolean(dr["IsActive"]);
        //  category.IsDeleted = Convert.ToBoolean(dr["IsDeleted"]);
        //  category.Definition = dr["Definition"].ToString();
        //  category.Description = dr["Description"].ToString();
        //  //if (dr["ImageType"].ToString() != "")
        //  //{
        //  //  category.ImageBytes = (byte[])dr["ImageBytes"];
        //  //  category.ImageType = dr["ImageType"].ToString();
        //  //}
        //  //else
        //  //{
        //  //  category.ImageType = string.Empty;
        //  //  category.ImageBytes = null;
        //  //}
        //  category.ImageType = dr["ImageType"].ToString() ?? string.Empty;
        //  category.ImageBytes = (byte[])dr["ImageBytes"] ?? null;
      ...
      catch (SqlException sqlex)
      {
        ...
        {
          // Tablo yok
          CreateCategoryTable(out result);
    ...
    public void DeleteCategory(out ResultObject result, int Id, CrudOperations operation, MarketUser currentUser)
    {
      result = new ResultObject();
      result.OriginProcess = $"{MethodBase.GetCurrentMethod().DeclaringType.FullName}.{MethodBase.GetCurrentMethod().Name}";
    ...
    public void InsertCategory(out ResultObject result, Category category, MarketUser currentUser)
    {
      result = new ResultObject();
      result.OriginProcess = $"{MethodBase.GetCurrentMethod().DeclaringType.FullName}.{MethodBase.GetCurrentMethod().Name}";
    ...
    public void UpdateCategory(out ResultObject result, Category category, MarketUser currentUser)
    {
      result = new ResultObject();
      result.OriginProcess = $"{MethodBase.GetCurrentMethod().DeclaringType.FullName}.{MethodBase.GetCurrentMethod().Name}";
    ...
    public void UpdateCategory(out ResultObject result, List<Category> categories, MarketUser currentUser)
    {
      result = new ResultObject();
      result.OriginProcess = $"{MethodBase.GetCurrentMethod().DeclaringType.FullName}.{MethodBase.GetCurrentMethod().Name}";
      result.Title = "Güncelleme işlemi";
